...
class farcoast_animation:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.ds = farcoast_ds
        self.var_animate = var_animate
        self.var_percentile = var_percentile
        self.var_max = var_max
        self.first_time_frame = first_time_frame
        self.final_time_frame = final_time_frame
